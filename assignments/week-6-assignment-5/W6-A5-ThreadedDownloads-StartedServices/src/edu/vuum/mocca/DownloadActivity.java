...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
            	...
            	String path = (String) msg.getData().get(DownloadUtils.PATHNAME_KEY);
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent i = DownloadIntentService.makeIntent(this, handler, getUrlString());
        	startService(i);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	i = ThreadPoolDownloadService.makeIntent(this, handler, getUrlString());
        	startService(i);
